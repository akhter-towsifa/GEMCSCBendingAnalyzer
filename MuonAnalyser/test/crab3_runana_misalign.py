...
config.General.workArea = 'CRUZET_Allruns_TP_chamber_after_endcaps_sep13'#working dir 
...
config.JobType.inputFiles = ['/afs/cern.ch/work/d/daebi/analyser/new_ana_test/src/GEMCSCBendingAnalyzer/MuonAnalyser/test/ME11Seg_CRUZET_allruns_chamber_after_endcaps_sep9.db']
