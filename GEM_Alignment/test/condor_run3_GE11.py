...
#process.GlobalTag = GlobalTag(process.GlobalTag, '160X_dataRun3_Prompt_frozen260223_v1', '')
...
options.register ('inputFile',
      ...
      "Input file path")
options.register ('outputFileNumber',
      '',
      VarParsing.multiplicity.singleton,
      VarParsing.varType.string,
      "Output file index")
...
outfile = f"/eos/user/t/toakhter/tamu_mual/2026/patrick_stup/out_{options.outputFileNumber}.root"
process.source.fileNames.append(f'file:{options.inputFile}')
#process.source.fileNames.append('root://cms-xrd-global.cern.ch//store/data/Run2026B/Muon0/RAW-RECO/ZMu-PromptReco-v1/000/401/844/00000/02856cb0-011e-49ac-9d66-aa3777412b8e.root')
