...
process.GEMAlDBWriter = cms.EDAnalyzer("GEMAlDBWriter",
                                       ...
                                       chamberFile = cms.untracked.string('../script/standAloneGemAlignment/2022D_globalMu_pfisotight_v6_ME11Seg_Prop_out_CutNumber1.csv'),          # GEM Chamber Alignment csv
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    connect = cms.string('sqlite_file:2022D_globalmu_v6.db')
)
